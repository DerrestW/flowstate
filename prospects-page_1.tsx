        ...
        <div style={{ display:"flex", flexDirection:"column", gap:"1rem" }}>
          ...
          <div style={{ background:"#fff", borderRadius:14, border:"0.5px solid rgba(6,7,8,0.08)", overflow:"hidden" }}>
            ...
            <div style={{ padding:"1.25rem", display:"flex", flexDirection:"column", gap:"0.875rem" }}>
              ...
              <div style={{ borderTop:"0.5px solid rgba(6,7,8,0.08)", paddingTop:"0.875rem", marginTop:"0.5rem" }}>
                <label style={lbl}>Or Upload a Contact List (CSV)</label>
                <label style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"10px", borderRadius:100, border:`1.5px dashed ${BLUE}`, cursor:uploading?"not-allowed":"pointer", fontSize:13, fontWeight:700, color:uploading?"rgba(6,7,8,0.3)":BLUE, fontFamily:"inherit" }}>
                ...
                <div style={{ fontSize:10, color:"rgba(6,7,8,0.4)", marginTop:4, textAlign:"center" }}>Columns: Name, Email, Title, Department, City, State</div>
                {uploadResult && (
